...
public class StepFragment5 extends ButterKnifeFragment implements Step {
...
//    TextView E_Moo;
    ...
    public static StepFragment5 newInstance(@LayoutRes int layoutResId) {
        Bundle args = new Bundle();
        args.putInt(LAYOUT_RESOURCE_ID_ARG_KEY, layoutResId);
        StepFragment5 fragment = new StepFragment5();
