...
public class StepFragment4 extends ButterKnifeFragment implements Step {
...
//    TextView E_Moo;
    ...
    public static StepFragment4 newInstance(@LayoutRes int layoutResId) {
        Bundle args = new Bundle();
        args.putInt(LAYOUT_RESOURCE_ID_ARG_KEY, layoutResId);
        StepFragment4 fragment = new StepFragment4();
